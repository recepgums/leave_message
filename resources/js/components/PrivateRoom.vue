<template>
    <div class="d-flex flex-wrap text-center">
        <div class="p-4 " v-for="(item,key) in data" :key="key"
             style="width:430px;height:350px;margin-left: auto;margin-right: auto;">
            <div class="card card-small card-post mb-4" name="kart"
                ...
                <div class="card-body row text-center " style="height:10px;">
                    <div
                        v-if="item.title.includes('www.youtube.com') || item.title.includes('m.youtube.com') || item.title.includes('youtu.be')"
                    ...
                    <div v-else-if="item.title.includes('open.spotify.com')"
                         class="iframe-container text-center align-self-center ">
                        <iframe :src="spotify(item.title)" frameborder="0" allowtransparency="true"
                    ...
                    <div v-if="item.password !== null" class="text-center"
                        ...
                        <input style="width: auto;margin-left: auto;margin-right: auto;" v-model="item.new_password"
                    ...
                    <div v-else-if="item.file_name !== null" class="text-center full-width">
                        <a :href="'/storage/private_room_files/'+item.file_name" target="_blank"
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get(appUrl + '/api/private_room/' + this.number)
                .then((response) => {
        ...
        methods: {
            ajax_password: function (event, id, password) {
                axios.post(appUrl + '/ajaxprivate', {id: id, password: password})
                    .then((response) => {
